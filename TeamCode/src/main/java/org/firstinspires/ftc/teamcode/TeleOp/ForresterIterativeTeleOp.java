...
//@Disabled
@TeleOp(name="Forrester's Iterative TeleOp", group="Iterative Opmode")
public class ForresterIterativeTeleOp extends OpMode {
...
//        multTelemetry.addData("Slow Down", "[LB2]");
    ...
    public void loop() {
        ...
        //                  DROPPER / GRIPPER               //
        robot.dropper.update(BC.get(DPAD_R, TAP), BC.get(DPAD_L, DOWN));
        ...
        //                  SPEED CONTROLS                  //
        double power = (BC.get(LB2, TOGGLE)) ? 0.2 : 0.5;
